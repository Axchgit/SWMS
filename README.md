...
├─teacher_student_demand.php  		查询学生
├─teacher_student_list.php 		学生列表/学生评分
├─teahcer_student_mark.php		学生评分打分页面
├─teacher_student_work.php		学生作业
├─teacher_swork_list.php  		学生作业列表/打分/下载
├─teahcer_swork_mark.php 		作业打分页面
├─teahcer_work_delete.php 		学生作业删除
