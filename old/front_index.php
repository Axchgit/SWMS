...
<section class="topNav">
    ...
    <nav class="navbar navbar-defined navbar-fixed-top">
        <div class="container">
            <a href="#">首页</a>
            <a href="fengcai.html">学校风采</a>
            <a href="jianjie.html">学校简介</a>
            <a href="liuyan.php">学生留言</a>
...
<section class="message clearfix">
    ...
    <div class="container">
        ...
        <div class="message_left fl text-center">
            <div class="rukou">
            	<div class="jw">
                    <span ><a href="login.html">教务中心</a></span>               
                </div>
                <div class="ks">
                    <span ><a href="#">河池学院考试网</a></span>               
                </div>
                 <div class="zy">
                    <span ><a href="#">教学资源库</a></span>               
                </div>
                <div class="js">
                    <span ><a href="#">教师发展中心</a></span>               
                </div>
                <div class="pyfa">
                    <span ><a href="#">本科专业培养方案</a></span>               
                </div>
            	<div class="jw">
                    <span ><a href="login.html">信息化服务中心</a></span>               
                </div>
