...
<form method="post" action="select_save.php">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder">学生个人信息</strong></div>
...
?>
  ...
  <tr>
    ...
    <!--<td align="center"><a href="teacher_student_mark.php?sno=<?php echo $row['stu_number']?>">评分/修改</a>|<a href="del.php?sid=<?php echo $row['id']?>&del=student" onClick="return confirm('真的要删除吗？')">禁选</a></td>-->	
  </tr>
  <?php 
        } 
