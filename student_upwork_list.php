...
?>
  ...
  <tr>
    ...
    <td align="center"><a href="del.php?id=<?php echo $row['id']?>&del=student_work&address=<?php echo $row['address']?>" onClick="return confirm('真的要删除吗？')">删除</a>|<a href="<?php echo $row['address']?>">下载</a></td>	
  </tr>
  <?php 
        } 
