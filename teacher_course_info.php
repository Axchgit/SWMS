...
<form method="post" >
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder">授课信息</strong></div>
...
<?php
  ...
  $fc=new func;
  $sql="select * from course where tea_number=$tno ";
...
<!--    <td align="center"><a href="xg_c.php?id=<?php echo $row['id']?>">修改</a>|<a href="del.php?cid=<?php echo $row['id']?>&del=course" onClick="return confirm('真的要删除吗？')">删除</a></td>	-->
  </tr>
  <?php 
        } 
