...
$sql = "select a.*,c.grade,c.course_number,b.course_number
    	...
    	where a.stu_number=c.stu_number and c.course_number=b.course_number and b.tea_number=t.tea_number and t.tea_number=$tno";
...
?>
  ...
  <tr>
    ...
    <td align="center"><a href="teacher_student_mark.php?sno=<?php echo $row['stu_number']?>">评分/修改</a>|<a href="teacher_student_cancel.php?sno=<?php echo $row['stu_number']?>&cno=<?php echo  $row['course_number'] ?>" onClick="return confirm('确定使其退选吗？')">退课</a></td>	
  </tr>
  <?php 
        } 
