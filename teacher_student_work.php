...
<body style="background:url(images/login_bg.jpg); background-repeat:no-repeat; text-align:center; background-size: 100%;">
    ...
    where c.twork_id=$wid and a.tea_number=b.tea_number and b.course_number=c.course_number and a.tea_number=$yh";
        $result = $link->query($sql);
        ?>
        <div style="background-color: rgb(209, 224, 222)" class="panel-head"><strong class="">
                <h2 style="color: green;font-weight:bolder"><?php echo $wname ?></h2>
            </strong></div>
        ...
        <table class="table table-hover text-center">
            ...
            ?>
                ...
                <tr>
                    ...
                    <td align="center"><a href="teacher_swork_mark.php?wname=<?php echo $wname ?>&wid=<?php echo $wid ?>&id=<?php echo $row['id'] ?>"><button class="button_new button_green">评分</button></a>
